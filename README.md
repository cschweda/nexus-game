...
- The objective is to build ascending sequences of cards that add up to a defined target number.
  ...
  - When playing with physical cards, these same limits apply.h a minimum possible value of 5 (all cards are 1) and a maximum of 65 (all cards are 13).
- At the start, the game shuffles a 52-card play deck and a 10-card Fixit deck.
- The player is dealt 5 cards from the play deck and 2 Fixit cards (face down) from the Fixit deck.
...
- You are dealt 5 regular cards and 2 Fixit cards (face down).
